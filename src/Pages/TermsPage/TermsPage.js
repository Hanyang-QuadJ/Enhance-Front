...
class TermsPage extends Component {
  ...
  handleTypeKor = () => {
    this.setState({ type: "kor" });
  };

  handleTypeEng = () => {
    this.setState({ type: "eng" });
  };
    ...
    return (
      <div className="termsPage">
        ...
        <div className="termsPage__content">
          <div className="termsPage__content__tabs">
            <div
              className={cx("termsPage__content__tabs__kor", {
                "termsPage__content__tabs-active": this.state.type === "kor"
              })}
              onClick={this.handleTypeKor}
            >
              한국어
            </div>
            <div>|</div>
            <div
              className={cx("termsPage__content__tabs__eng", {
                "termsPage__content__tabs-active": this.state.type === "eng"
              })}
              onClick={this.handleTypeEng}
            >
              English
            </div>
          </div>
          ...
          {type === "kor" ? (
            <div style={{ paddingBottom: "3rem" }}>
              ...
              <p>
                ...
                Korea)&gt;(&lsquo;Coinhub.kr&rsquo;이하 &lsquo;코인허브
                (Coinhub)&rsquo;) 은(는) 다음의 목적을 위하여 개인정보를
                처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.<br />-
              ...
              <p>
                ① &lt;인핸스 코리아 (Enhance
                Korea)&gt;(&lsquo;Coinhub.kr&rsquo;이하 &lsquo;코인허브
                (Coinhub)&rsquo;) 은(는) 정보주체로부터 개인정보를 수집할 때
                동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보
                보유․이용기간 내에서 개인정보를 처리․보유합니다.
              </p>
              <p>
                ② 구체적인 개인정보 처리 및 보유 기간은 다음과 같습니다.<br />☞
                아래 예시를 참고하여 개인정보 처리업무와 개인정보 처리업무에
                대한 보유기간 및 관련 법령, 근거 등을 기재합니다.<br />(예시)-
                고객 가입 및 관리 : 서비스 이용계약 또는 회원가입 해지시까지,
                다만 채권․채무관계 잔존시에는 해당 채권․채무관계 정산시까지<br />-
                전자상거래에서의 계약․청약철회, 대금결제, 재화 등 공급기록 : 5년
              </p>
              <p>&nbsp;</p>
              <p>
                <br />3. 개인정보의 제3자 제공에 관한 사항
              </p>
              <p>
                ① &lt;인핸스 코리아 (Enhance Korea)&gt;('Coinhub.kr'이하
                '코인허브 (Coinhub)')은(는) 정보주체의 동의, 법률의 특별한 규정
                등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만
                개인정보를 제3자에게 제공합니다.
              </p>
              <p>
                ② &lt;인핸스 코리아 (Enhance Korea)&gt;('Coinhub.kr')은(는)
                다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
              </p>
              <p>
                <br />1. <br />- 개인정보를 제공받는 자 : J. Yoon<br />-
                제공받는 자의 개인정보 이용목적 : 이메일, 비밀번호, 로그인ID,
                서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보<br />- 제공받는
                자의 보유.이용기간: 준영구
              </p>
              <p>&nbsp;</p>
              <p>4. 개인정보처리 위탁</p>
              <p>
                ① &lt;인핸스 코리아 (Enhance Korea)&gt;('코인허브
                (Coinhub)')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이
                개인정보 처리업무를 위탁하고 있습니다.
              </p>
              <p>
                1. &lt;타게팅 광고용 쿠키 수집&gt;<br />- 위탁받는 자 (수탁자) :
                Google Adsense<br />- 위탁하는 업무의 내용 : 신규 서비스(제품)
              ...
              <p>
                ② &lt;인핸스 코리아 (Enhance Korea)&gt;('Coinhub.kr'이하
                '코인허브 (Coinhub)')은(는) 위탁계약 체결시 개인정보 보호법
              ...
              <p>
                ...
                개인정보 처리방침을 통하여 공개하도록 하겠습니다.<br />5.
                정보주체와 법정대리인의 권리&middot;의무 및 그 행사방법 이용자는
                개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.
              </p>
              <p>
                ① 정보주체는 인핸스 코리아 (Enhance
                Korea)(&lsquo;Coinhub.kr&rsquo;이하 &lsquo;코인허브 (Coinhub))
                에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할
                수 있습니다.<br />1. 개인정보 열람요구<br />2. 오류 등이 있을
                경우 정정 요구<br />3. 삭제요구<br />4. 처리정지 요구
              </p>
              <p>&nbsp;</p>
              <p>6. 처리하는 개인정보의 항목 작성</p>
              <p>
                ① &lt;인핸스 코리아 (Enhance Korea)&gt;('Coinhub.kr'이하
                '코인허브 (Coinhub)')은(는) 다음의 개인정보 항목을 처리하고
                있습니다.
              </p>
              <p>&nbsp;</p>
              <p>
                7. 개인정보의 파기&lt;인핸스 코리아 (Enhance
                Korea)&gt;('코인허브 (Coinhub)')은(는) 원칙적으로 개인정보
                처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다.
                파기의 절차, 기한 및 방법은 다음과 같습니다.
              </p>
              <p>
                -파기절차<br />이용자가 입력한 정보는 목적 달성 후 별도의 DB에
              ...
              <p>
                -파기기한<br />이용자의 개인정보는 개인정보의 보유기간이 경과된
                경우에는 보유기간의 종료일로부터 5일 이내에, 개인정보의 처리
              ...
              <p>&nbsp;</p>
              <p>
                8. 개인정보 자동 수집 장치의 설치&bull;운영 및 거부에 관한 사항
              </p>
              <p>
                ① 인핸스 코리아 (Enhance Korea) 은 개별적인 맞춤서비스를
                제공하기 위해 이용정보를 저장하고 수시로 불러오는
                &lsquo;쿠기(cookie)&rsquo;를 사용합니다. ② 쿠키는 웹사이트를
                운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게
                보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에
                저장되기도 합니다. 가. 쿠키의 사용 목적 : 이용자가 방문한 각
                서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어,
                보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을
                위해 사용됩니다. 나. 쿠키의 설치&bull;운영 및 거부 : 웹브라우저
              ...
              <p>
                ▶ 개인정보 보호책임자 <br />성명 :J. Lee<br />직책 :사업본부장<br />직급
                :공동대표<br />연락처 :01020480361, lee@collector.org, X<br />※
                개인정보 보호 담당부서로 연결됩니다.
              </p>
              <p>
                ▶ 개인정보 보호 담당부서<br />부서명 :Back-end Dev<br />담당자
                :J. Yoon<br />연락처 :01058797799, coinhubservice@email.com, X<br />②
                정보주체께서는 인핸스 코리아 (Enhance
                Korea)(&lsquo;Coinhub.kr&rsquo;이하 &lsquo;코인허브 (Coinhub))
                의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호
                관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
                보호책임자 및 담당부서로 문의하실 수 있습니다. 인핸스 코리아
                (Enhance Korea)(&lsquo;Coinhub.kr&rsquo;이하 &lsquo;코인허브
                (Coinhub)) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및
                처리해드릴 것입니다.
              </p>
              <p>&nbsp;</p>
              <p>10. 개인정보 처리방침 변경</p>
              ...
              <p>
                7. 문서보안을 위한 잠금장치 사용<br />개인정보가 포함된 서류,
                보조저장매체 등을 잠금장치가 있는 안전한 장소에 보관하고
                있습니다.
              </p>
              <p>
                8. 비인가자에 대한 출입 통제<br />개인정보를 보관하고 있는
                물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립,
                운영하고 있습니다.
              </p>
              <p>&nbsp;</p>
              <p>
                <br />12. 개인정보 열람청구<br />① 정보주체는 개인정보 보호법
                제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수
                있습니다. &lt;인핸스 코리아 (Enhance
                Korea)&gt;(&lsquo;Coinhub.kr'이하 '코인허브 (Coinhub)')은(는)
                정보주체의 개인정보 열람청구가 신속하게 처리되도록
                노력하겠습니다.
              </p>
              <p>
                ▶ 개인정보 열람청구 접수&middot;처리 부서 <br />부서명 :
                Back-End Dev<br />담당자 : J. Yoon<br />연락처 : 01058797799,
                coinhubservice@email.com, X
              </p>
              <p>
                <br />② 정보주체께서는 제1항의 열람청구 접수․처리부서 이외에,
                행정안전부의 &lsquo;개인정보보호 종합지원 포털&rsquo;
                웹사이트(www.privacy.go.kr)를 통하여서도 개인정보 열람청구를
                하실 수 있습니다.
              </p>
              <p>
                ▶ 행정안전부 개인정보보호 종합지원 포털 &rarr; 개인정보 민원
                &rarr; 개인정보 열람등 요구 (본인확인을 위하여 아이핀(I-PIN)이
                있어야 함)
              </p>
            </div>
          ) : (
            <div>
              ...
              <p>
                The Coinhub website located at coinhub.kr is a copyrighted work
                belonging to Enhance Korea. Certain features of the Site may be
              ...
              <p>
                ...
                exclusively responsible for your User Content. You bear all
                risks associated with use of your User Content.  You hereby
                ...
                User Content may be deleted at any time without prior notice to
                you. You are solely responsible for making your own backup
              ...
              <p>
                ...
                Content in the Site.  You hereby irreversibly waive any claims
              ...
              <p>
                ...
                physical harm of any kind against any group or individual; (iii)
              ...
              <p>
                ...
                sole discretion if you violate the Acceptable Use Policy or any
                other provision of these Terms or otherwise create liability for
                us or any other person. Such action may include removing or
                modifying your User Content, terminating your Account in
                accordance with Section 8, and/or reporting you to law
              ...
              <p>
                ...
                manner it believes appropriate.  Company will treat any Feedback
              ...
              <p>
                ...
                relief.  A Notice to the Company should be sent to: 60,
                Samgae-ro, Yongsan-gu, Seoul, South Korea. After the Notice is
              ...
              <p>Address: 60, Samgae-ro, Yongsan-gu, Seoul, South Korea</p>
              <p>Email: coinhub@email.com</p>
            </div>
          )}
        </div>
        <Footer type="terms" />
...
export default withRouter(connect(mapStateToProps)(TermsPage));
